...
def student_counter_fun():
    project_configs = get_project_config_data("04 Student headcount Tracker")
    print(project_configs)
    # Initialize sensors 
    sensor1_pin = set_pin_in(project_configs["sensor1_pin"])
    sensor2_pin = set_pin_in(project_configs["sensor2_pin"])
